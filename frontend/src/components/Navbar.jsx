      ...
      <div className="navbar-whole">
        ...
        <div className="navbar-buttons">
          <div id="recipe-creation-methods">
            ...
            >
              <div className="menu-item" onClick={handleURLImport}>
                Importuj z URL
              </div>
              <div>
                ...
                <input
                  ...
                  ref={fileInput}
                  style={{ opacity: 0 }}
                  onChange={() => setThisShouldntBeDone((old) => !old)}
                />
                {fileInput.current && (
          ...
          <div id="export-recipes-methods">
            <a className="navbar-button">Eksportuj przepisy</a>
            <div id="rolldown-menu" className="closed">
              <div className="menu-item" onClick={handleExportToFile}>
                Eksport do pliku
              </div>
              <div className="menu-item" onClick={handleExportToGoogleDrive}>
